...
export default {
    ...
    created() {
        this.$store.commit('setTitle', 'Topics')
        this.getCategories()
    },
    computed: {
        isHome() {
